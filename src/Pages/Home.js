...
export default function Home() {
  ...
  return (
    <>
     <section id='navbar' className='shadow-lg bg-[white] shadow-slate-700 py-[20px] px-[] px-[10px] fixed w-full flex items-center justify-between'>
       <h1 className='font-bold text-[30px]'>ESCOIL</h1>
       
       <img onClick={profileNavigate} src='./assets/svg-icon/profile.svg' className='w-[40px]'></img>
       ...
       {/* <div className='bg-[black] rounded-full h-[30px] w-[30px]'></div> */}
        ...
        <section id='body' className='grid grid-cols-3 gap-[50px] px-[20px] pt-[100px] pb-[30px]'>
            <section id='body1' className='flex gap-[20px] flex-col rounded-[20px]'>
                ...
                <div className='flex gap-[20px] items-center hover:bg-[grey] p-[10px] rounded-[40px]'>
                    <img src='./assets/svg-icon/bookmark.svg' className='w-[50px]'></img>
